          ...
          try {
            ...
            if (countResult[0].count === 0) {
              ...
              await connection.query(insertQuery, [
                kode, item.nim, item.nama, item.idperiode, item.statusmhs, item.nip, item.dosenpa, item.ips, item.ipk, item.skssemester, item.skstotal, item.ipklulus, item.skslulus, item.batassks, item.skstempuh, item.semmhs, item.tglsk, item.nosk
              ]);
