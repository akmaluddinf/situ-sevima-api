...
const apiUrl = `${apiBaseUrl}live/pendaftar`;
const namaApi = apiUrl.split('/').pop();
const namaTabel = "trn_pendaftar"
        ...
        await Promise.all(dataFromApi.map(async (item) => {
          ...
          try {
            ...
            if (countResult[0].count === 0) {
              ...
              const insertQuery = `INSERT INTO ${namaTabel} (
                kode, 
                kodependaftar,
                periodedaftar,
                gelombang,
              ...
              await connection.query(insertQuery, [
                ...
                item.jenispilihan,
                item.tanggaldaftar,
                item.tanggalaktivasiakun,
                item.statusaktif,
                item.statusfinalisasi,
                item.statusdaftar,
                item.statusbidikmisi,
                item.statusdiumumkan,
                item.nim,
                item.noujian,
                item.perekomendasi,
                item.nik,
